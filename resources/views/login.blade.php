  ...
  <body  class=" border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
      <div class="container-tight py-4">
        <form class="card card-md" action="{{ route('admin.postLogin') }}" method="post" autocomplete="off">
            @csrf
          <div class="card-body">
        ...
        <div class="text-center text-muted mt-3">
            Bạn chưa có tài khoản? <a href="{{ route('admin.registration') }}" tabindex="-1">Đăng ký</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
