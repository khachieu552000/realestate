        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row row-cards">
                    <div class="col-12">
                        <form action="{{ route('add-district') }}" method="post" class="card">
                            @csrf
                            <div class="card-header">
                                <h4 class="card-title">Thêm mới Quận/Huyện</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name_district" value="{{ old('name_district') }}" />
                                                @error('name_district')
                                                <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
