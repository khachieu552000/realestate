        ...
        <div class="page-body">
            <div class="container-xl">
                <div class="row row-cards">
                    <div class="col-12">
                        <form action="{{ route('update-ward', ['id_ward' => $ward->id]) }}" method="post" class="card">
                            @csrf
                                    ...
                                    <div class="col-xl-8">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name_ward" value="{{ $ward->name }}" />
                                                @error('name_ward')
                                                <p style="color: red">{{ $message }}</p>
                                                @enderror
                                            </div>
