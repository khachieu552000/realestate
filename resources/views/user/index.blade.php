...
<div role="main" class="main">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="item">
            <img src="{{ asset($item->image) }}" alt="Chicago" style="width:100%;">
          </div>
          @endforeach
        </div>
                        ...
                        <div class="col-sm-6 col-md-8">
                            <div class="property-thumb-info">
                                ...
                                <div class="amenities clearfix">
                                    <ul class="pull-left">
                                        <li><strong>Đăng bởi: </strong>{{ $item->account->user_info->name }}.</li> <br>
                                        <li><i class="fa fa-phone" aria-hidden="true"></i> {{ $item->account->user_info->phone }}</li>
                                    </ul>
                                    <ul class="pull-right">
                                        <li>Ngày đăng: {{ date('d/m/Y', strtotime($item->start_date))  }}</li> <br>
                                        <li>Ngày kết thúc: {{ date('d/m/Y', strtotime($item->end_date))  }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 animation about-item">
                    ...
                    <a href="{{ route('show-about') }}" style="height:35px" class="btn btn-lg btn-default">Chi tiết</a>
                </div>
                <div class="col-md-4 animation about-item">
