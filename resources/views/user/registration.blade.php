    ...
    <div class="page page-center">
      <div class="container-tight py-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label class="form-check">
                ...
                <span class="form-check-label">Đồng ý các <a href="./terms-of-service.html" tabindex="-1">điều khoản và chính sách</a>.</span>
              </label>
            </div>
        ...
        <div class="text-center text-muted mt-3">
          Đã có tài khoản? <a href="{{ route('admin.login') }}" tabindex="-1">Đăng nhập</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
